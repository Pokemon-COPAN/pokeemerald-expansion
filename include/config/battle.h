...
#define B_WIDE_GUARD                GEN_5      // In Gen5 only, Quick Guard has a chance to fail if used consecutively.
#define B_QUICK_GUARD               GEN_5      // In Gen5 only, Wide Guard has a chance to fail if used consecutively.
