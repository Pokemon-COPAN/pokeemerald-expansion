...
const struct Tileset gTileset_Primary_Test =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_Primary_Test,
    .palettes = gTilesetPalettes_Primary_Test,
    .metatiles = gMetatiles_Primary_Test,
    .metatileAttributes = gMetatileAttributes_Primary_Test,
    .callback = NULL,
};
