...
const u16 gMetatiles_Primary_Test[] = INCBIN_U16("data/tilesets/primary/primary_test/metatiles.bin");
const u16 gMetatileAttributes_Primary_Test[] = INCBIN_U16("data/tilesets/primary/primary_test/metatile_attributes.bin");
