static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_SANDBOX_GYM - 1] = {MAP_GROUP(SANDBOX_GYM), MAP_NUM(SANDBOX_GYM), 21, 10},
    [HEAL_LOCATION_ISLANDVIEW_TOWN - 1] = {MAP_GROUP(ISLANDVIEW_TOWN), MAP_NUM(ISLANDVIEW_TOWN), 10, 10},
    [HEAL_LOCATION_COPAN_ROUTE101 - 1] = {MAP_GROUP(COPAN_ROUTE101), MAP_NUM(COPAN_ROUTE101), 10, 13},
};
