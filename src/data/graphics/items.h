...
const u32 gItemIcon_CommonCandy[] = INCBIN_U32("graphics/items/icons/common_candy.4bpp.lz");
const u32 gItemIconPalette_CommonCandy[] = INCBIN_U32("graphics/items/icon_palettes/rare_candy.gbapal.lz"); //TO DO
